...
pandoc $tempPath --toc --lof --citeproc --bibliography=PanDoc/References.bib --csl PanDoc/Templates/ieee-with-url.csl --filter mermaid-filter.cmd --top-level-division=chapter -o $outputFile --reference-doc=PanDoc/Templates/article.docx
