...
![Figura 5.1. Diálogo visible sobre PowerPad](./Pictures/Pasted-image-20250531175903.png)

2) El diálogo mostrado guía el usuario durante la descarga e instalación Ollama: **OllamaDownloadHelper**

![Figura 5.2. Diálogo de descarga e instalación de Ollama: Paso 1](./Pictures/Pasted-image-20250524150303.png)

![Figura 5.3. Diálogo de descarga e instalación de Ollama: Paso 2](./Pictures/Pasted-image-20250524150402.png)

![Figura 5.4. Diálogo de descarga e instalación de Ollama: Paso 3](./Pictures/Pasted-image-20250524151653.png)

![Figura 5.5. Diálogo de descarga e instalación de Ollama: Paso 4](./Pictures/Pasted-image-20250524151506.png)

![Figura 5.6. Diálogo de descarga e instalación de Ollama: Paso 5](./Pictures/Pasted-image-20250524151603.png)
...
![Figura 5.9. Página de gestión de modelos](./Pictures/Pasted-image-20250531180639.png)

2) El usuario pulsa en `Añadir modelos` y accede a la página de búsquedas de modelos: **OllamaAddModelPage**

![Figura 5.10. Página de descargas de modelos](./Pictures/Pasted-image-20250531182151.png)
...
![Figura 5.14. Página de gestión de agentes](./Pictures/Pasted-image-20250531191910.png)

2) El usuario pulsa en `Añadir agente` y accede al componente de creación de agentes: **AgentEditor**

![Figura 5.15. Creación de un agente](./Pictures/Pasted-image-20250531192518.png)
#### Clases implicadas
...
![Figura 5.18. Página de espacio de trabajo](./Pictures/Pasted-image-20250531195439.png)

2) El usuario pulsa en `Nuevo chat` y accede a la nueva conversación: **ChatEditorControl**

![Figura 5.19. Nueva conversación](./Pictures/Pasted-image-20250531204203.png)

3) El usuario escribe su mensaje, lo envía, y recibe la respuesta a medida que se genera: **ChatEditorControl**

![Figura 5.20. Conversación en curso](./Pictures/Pasted-image-20250531195411.png)
...
![Figura 5.24. Enviamos al modelo la conversación, incluyendo las instrucciones del agente como mensaje de sistema.](./Pictures/Pasted-image-20250610195020.png)
...
5. Usuario: Pulsa sobre el switch de enviar parámetros.
...
![Figura 5.25. Página de espacio de trabajo](./Pictures/Pasted-image-20250531195439.png)

2) El usuario pulsa en `Nuevo chat` y accede a la nueva conversación: **ChatEditorControl**

![Figura 5.26. Nueva conversación](./Pictures/Pasted-image-20250531204203.png)

3) El usuario ajustas los parámetros antes de enviar su mensaje: **ChatEditorControl**

![Figura 5.27. Panel de parámetros](./Pictures/Pasted-image-20250609000458.png)

4) El usuario escribe su mensaje, lo envía, y recibe la respuesta a medida que se genera: **ChatEditorControl**

![Figura 5.28. Conversación en curso](./Pictures/Pasted-image-20250609000248.png)
...
sequenceDiagram
    ...
    participant CC as ChatControl
    participant MSVM as ModelsSettingsViewModel
    participant CCP as ChatControlParametros
    participant CS as ChatService
    actor IA as Proveedor IA
...
![Figura 5.30. Enviamos al modelo la conversación, incluyendo las instrucciones indicadas en los parámetros de la conversación.](./Pictures/Pasted-image-20250610195347.png)
...
![Figura 5.31. Página de espacio de trabajo](./Pictures/Pasted-image-20250531200423.png)

2) El usuario pulsa en `Nuevo nota`, introduce sus anotaciones y solicita la edición: **TextEditorControl**

![Figura 5.32. Nueva nota](./Pictures/Pasted-image-20250531201041.png)

3) El usuario pulsa en visualiza las anotaciones corregidas: **TextEditorControl**

![Figura 5.33. Nota modificada](./Pictures/Pasted-image-20250531203859.png)
...
![Figura 5.37. Durante una edición de nota, se concatenan las instrucciones del agente, el parámetro (si el agente lo tiene) y las instrucciones de edición. Se recibe del modelo la nota modificada.](./Pictures/Pasted-image-20250610200427.png)

![Figura 5.38. Ejemplo de uso de un agente traductor durante la edición con prompts reales. El prompt de edición indica al modelo que recibirá en el mensaje del usuario la nota que debe ser modificada en su respuesta.](./Pictures/Pasted-image-20250610200451.png)
...
![Figura 5.39. Ventana emergente de edición rápida](./Pictures/Captura-de-pantalla-2025-05-24-170119.png)

2) El usuario selecciona el agente, escribe sus indicaciones y pulsa en enviar para ver el texto traducido: **PopupEditorPage**

![Figura 5.40. Texto traducido en ventana emergente](./Pictures/Captura-de-pantalla-2025-05-24-170214.png)
...
![Figura 5.44. Estructura de la colección de mensajes enviada en la generación de nombres por IA](./Pictures/Pasted-image-20250610235916.png)
...
![Figura 5.45. Ajustes mostrando Ollama disponible y botón iniciar el servicio](./Pictures/Pasted-image-20250609235742.png)

![Figura 5.46. Ajustes mostrando Ollama conectado y botón para parar el servicio](./Pictures/Pasted-image-20250609235816.png)
...
- **Configuración de Ollama**: Habilitar o deshabilitar el uso de Ollama, parar o iniciar el servicio, modificar la URL o elegir se se inicia o no Ollama automáticamente al abrir PowerPad.
...
- **Configuración por defecto**:
	...
	- **Parámetros por defecto**: Determina si se envía o no parámetros generativos de forma predeterminada, y permite elegir cuales: instrucciones de sistema, temperatura, top_p, número máximo de tokens generados y el tamaño máximo de la conversación.
...
![Figura 5.47. Página de ajustes - Parte 1](./Pictures/Pasted-image-20250610001357.png)

![Figura 5.48. Página de ajustes - Parte 2](./Pictures/Pasted-image-20250610001424.png)

![Figura 5.49. Página de ajustes - Parte 3](./Pictures/Pasted-image-20250610001459.png)
