...
![Figura 6.1. Diagrama de clases del área de IA del núcleo de PowerPad. Por simplificación se omiten aquellas relaciones de agregación de las implementaciones que son idénticas a las asociaciones de las interfaces que implementan. Elaboración propia con notación libre.](./Pictures/arquitectura1.drawio.png)

![Figura 6.2. Diagrama de clases del área de FileSystem del núcleo de PowerPad. Por simplificación se omiten aquellas relaciones de agregación de las implementaciones que son idénticas a las asociaciones de las interfaces que implementan. Elaboración propia con notación libre.](./Pictures/arquitectura2.drawio.png)

![Figura 6.3. Diagrama de clases del área de configuración del núcleo de PowerPad. Elaboración propia con notación libre.](./Pictures/arquitectura3.drawio.png)
...
![Figura 6.4. Diagrama de clases de elementos visuales de la interfaz de PowerPad. Todas las relaciones entre los elementos visuales son composiciones. Elaboración propia con notación libre.](./Pictures/arquitectura4.drawio.png)

![Figura 6.5. Relación entre elementos visuales y viewmodels de PowerPad. No se representan las relaciones entre componentes visuales y viewmodels cuando su único propósito es reenviar el viewmodel a un subcomponente cuya propia relación ya está reflejada en el diagrama. Elaboración propia con notación libre.](./Pictures/arquitectura5.drawio.png)
...
![Figura 6.4. Calendario de lanzamientos de .NET. Aunque .NET 9 ya está disponible, se ha optado por .NET 8 al ser la versión LTS más reciente en el momento del desarrollo del proyecto. Fuente: Directiva de soporte técnico oficial de .NET -@doc_dotnet_supportpolicy_2025.](./Pictures/Pasted-image-20250626181015.png)

En PowerPad, .NET 8 es clave para que la aplicación pueda ofrecer una experiencia rica visualmente, rápida y escalable, además de facilitar la integración con bibliotecas de terceros y servicios *cloud* o locales enfocados a la inteligencia artificial. El soporte a largo plazo de .NET 8 también aporta seguridad y estabilidad de cara a la actualización de dependencias en futuras ampliaciones del proyecto.
...
![Figura 6.5. Diagrama del API de abstracciones de Microsoft Extensions. Fuente: Introducción a Microsoft.Extensions.AI -@doc_ai_buildingblocks_2024.](./Pictures/meai-architecture-diagram.png)
...
![Figura 6.7. Estilos recomendados para aplicaciones modernas con Windows SDK. Fuente: Captura de WinUI 3 Gallery -@repository_winui_gallery.](./Pictures/Pasted-image-20250531002246.png)
...
En la solución desarrollada también se ha contemplado el proceso de empaquetado y distribución de la aplicación. Para ello se hace uso de la funcionalidad de crear paquetes de instalación desde el entorno de desarrollo **Visual Studio** [@product_visualstudio]. Esta funcionalidad ofrece al desarrollador la posibilidad de empaquetar su desarrollo en un instalador con formato **MSIX** [@product_visualstudio] firmado, lo que facilitaría una potencial publicación de la aplicación en **Microsoft Store** [@doc_publish_windowsstore_2024] a futuro.
