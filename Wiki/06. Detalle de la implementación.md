...
- **WinUIEx** [@winUIEx]: Es una colección de utilidades y extensiones que amplía las capacidades nativas de WinUI. En PowerPad se utiliza para enriquecer la interacción del usuario, por ejemplo modificando la barra de título en la ventana principal o generando la ventana de edición rápida sin barra de título.
- **Microsoft.Windows.CsWin32** [@cswin32_2025]: Genera automáticamente los enlaces necesarios para invocar el API de Win32 desde C#. Es útil para integrar ciertas funcionalidades del sistema operativo, como el registro de atajos de teclado (`HotKeys`) o la simulación de combinaciones de tecla para copiar y pegar.
- **Microsoft.Windows.SDK.BuildTools** [@buildtools]: Incluye las herramientas y cabeceras necesarias para compilar y empaquetar aplicaciones Windows modernas dirigidas a la última versión del sistema.
