...
-   **Open WebUI** [@WebUI]: Proporciona una interfaz rica en funciones para ejecutar modelos locales con integración de técnicas como RAG y búsqueda web.
-   **Enchanted** [@enchanted_2025]: Aplicación nativa para macOS con integración optimizada para sistemas Apple.
...
-   **LibreChat** [@librechat]: Un clon de ChatGPT de código abierto que también ofrece instalación y configuración como interfaz web.

##### Otras herramientas basadas en llama.cpp

-   **LM Studio** [@lm_studio]: Aplicación de escritorio enfocadas en gestionar y ejecutar modelos en formato GGUF, con opciones de personalización y compatibilidad con múltiples arquitecturas, no es de código abierto.
-   **Msty** [@msty]: Muy similar a LM Studio, también de código propietario.
-   **GPT4All** [@gpt4all_2025]: Proporciona una experiencia similar a ChatGPT, completamente local, con modelos optimizados para ejecución en CPU y GPU.
