...
![Figura 2.7. Captura de la interfaz de ChatGPT, aplicación web clave en el auge de las herramientas conversacionales con IA. Fuente: Captura de ChatGPT -@chatgpt.](./Pictures/Pasted-image-20250614174200.png)
...
![Figura 2.8. Debido al éxito de ChatGPT, su diseño rápidamente se convirtió en inspiración para multitud de herramientas. Además de la conversación en el bloque principal, casi todas presentan la misma disposición con un menú lateral izquierdo que contiene las opciones de nuevo chat y el histórico de conversaciones anteriores. Fuente: Capturas de Gemini -@gemini_webapp, Copilot -@copilot_2025, Le Chat -@lechat_2025, Claude -@claude_webapp, DeepSeek -@deepseek_webapp y Meta AI -@metai_2025.](./Pictures/Pasted-image-20250614180406.png)

#### Nuevas tendencias

* **Razonamiento y ediciones contextualizadas**

La investigación en modelos avanzados, como **o3** y **o4** (OpenAI) [@o3_o4] y **DeepSeek R1**, sugiere que las futuras aplicaciones conversacionales no se limitarán a generar respuestas inmediatas. En cambio, incorporarán capacidades de razonamiento previas a la generación del texto, lo que permitirá ofrecer respuestas más precisas y argumentadas. Además, los sistemas de edición colaborativa en tiempo real harán que la interacción entre usuarios y modelos sea más fluida y personalizada.
