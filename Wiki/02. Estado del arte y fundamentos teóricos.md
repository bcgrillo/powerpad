...
-   **2025: Explosión de nuevos modelos y servicios de IA generativa**
    ...
    El año 2025 arranca con una oleada de integraciones: DeepSeek lanza su modelo R1 [@deepseek-r1_2025] que asombra a la comunidad con su capacidad de razonamiento y bajo coste, Google termina de desplegar Gemini en los dispositivos Android [@gemini_press_2025], Microsoft incluye Copilot en la familia de productos Microsoft 365 [@copilot_press_2025], Meta logra lanzar en Europa MetaAI en WhatsApp [@metaai_europe_2025], y xAI habilita Grok de forma gratuita en su red social X [@fernandez_grok_2024]. La IA generativa se consolida como herramienta de uso cotidiano.
