    ...
    public static class ConfigConstants
    {
        ...
        public class StoreDefault
        {
            ...
            })
            {
                Icon = new AgentIcon
                {
                    Type = AgentIconType.FontIconGlyph,
                    Source = "\uE932",
                },
                Enabled = true
            };
            ...
            })
            {
                Icon = new AgentIcon
                {
                    Type = AgentIconType.CharacterOrEmoji,
                    Source = "✂️",
                },
                Enabled = true
            };
